...
export class CommonService {
  ...
  public currentLanguage: BehaviorSubject<string> = new BehaviorSubject<string>('jp');
  ...
  postMultipart(url: any, params: any) {
    ...
    return this.http.post<any>(environment.apiUrl + url, params, { headers: headers }).pipe(
      map(res => {
        return res;
      })
    );
